...
> A drop-in `fetch` that pays for [layer402](https://www.layer402.org/)-gated APIs automatically.
...
Part of [fourotwo](https://layer402layer-dashboard.vercel.app/docs): the trust & settlement layer for agent payments.
